...
| K1 | `POST /api/scenarios/{scenario_id}/simulate` | `{ recalculation_version?: str }` | `202 ImpactAssessment` | AuthN, AuthZ, tenant ownership, payload schema, interaction/double-counting validation, audit, safe errors |
...
| # | Endpoint | Request | Response | Security |
|---|---|---|---|---|
| N1 | `GET /api/facilities/{facility_id}/reporting-periods/{period_id}/dashboard` | — | `{ total_kgco2e, scope_breakdown, carbon_intensity, largest_hotspot, circularity_score, potential_reduction_kgco2e, potential_annual_saving, last_calculated_at, empty_state?: bool }` | AuthN, tenant ownership, safe errors |
