"""Thin re-export of :mod:`seed_interventions` (repo root) kept for
repo-root importers (tests). Runs from ``backend/`` use the root module
name to avoid the ``backend/tools`` package clash.
...
from seed_interventions import *  # noqa: F401,F403
from seed_interventions import full_intervention_rows, load_library_contracts
